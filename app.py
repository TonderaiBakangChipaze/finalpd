...
def update_viewership_stats(continents, sports, ages, genders, countries):
    if not continents:
...
def update_summary_stats(continents, sports, ages, genders, countries):
    if not continents:
        continents = ['Asia']  # Default continent
...
def update_viewership_visits_bar(continents, sports, ages, genders, countries):
    if not continents:
        continents = ['Asia']  # Default continent
    ...
    title = f"Average Viewership and Visits for {', '.join(continents)}"
...
def update_views_gauge(continents, sports, ages, genders, countries):
    if not continents:
        continents = ['Asia']  # Default continent
...
def update_conversion_rate(continents, countries, ages, genders):
    ...
    title = f"Viewership to Visits conversion Rate for {', '.join(continents)}"
...
def update_geo_distribution(continents, sports, ages, genders, countries):
    if not continents:
        continents = ['Asia']  # Default continent
...
def update_viewership_times(continents, sports, ages, genders, countries):
    if not continents:
        continents = ['Asia']  # Default continent
